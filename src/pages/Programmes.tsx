...
const colleges = [
  {
    ...
    programs: [
      ...
      { name: "Dental Therapy", degree: "B.Sc.", duration: "4 Years", description: "Provide preventive dental care and promote oral health education within diverse patient populations.", image: "https://images.unsplash.com/photo-1598256989800-fea5ce5146f2?q=80&w=600&auto=format&fit=crop" },
  ...
  },
  {
    ...
    programs: [
      ...
      { name: "Physics", degree: "B.Sc.", duration: "4 Years", description: "Explore the fundamental laws of nature and their applications in modern technology and research.", image: "https://images.unsplash.com/photo-1636466497217-26c8c540a877?q=80&w=600&auto=format&fit=crop" },
      ...
      { name: "Agricultural Economics", degree: "B.Agric.", duration: "5 Years", description: "Apply economic principles to optimize agricultural production, distribution, and consumption.", image: "https://images.unsplash.com/photo-1586771107445-d3afeb0dc06c?q=80&w=600&auto=format&fit=crop" },
      ...
      { name: "Mechatronics Engineering", degree: "B.Eng.", duration: "5 Years", description: "Combine mechanical, electrical, and computer engineering to create intelligent automated systems.", image: "https://images.unsplash.com/photo-1535378273640-2782a20e89e3?q=80&w=600&auto=format&fit=crop" },
    ]
  },
  {
    ...
    programs: [
      ...
      { name: "Sociology", degree: "B.Sc.", duration: "4 Years", description: "Investigate human behavior, social structures, and cultural dynamics in contemporary societies.", image: "https://images.unsplash.com/photo-1529156069898-49953eb1b5ce?q=80&w=600&auto=format&fit=crop" },
      ...
      { name: "Mass Communication", degree: "B.Sc.", duration: "4 Years", description: "Master the art of storytelling and media production in journalism, broadcasting, and digital media.", image: "https://images.unsplash.com/photo-1486820549448-f62f132dd441?q=80&w=600&auto=format&fit=crop" },
